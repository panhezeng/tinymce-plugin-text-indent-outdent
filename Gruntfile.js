...
module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    concat: {
      license: {
        ...
        files: {
          'dist/tinymce-plugin-text-indent-outdent/plugin.js': [
            'src/text/license-header.js',
            scratchPluginMinPath
          ],
          'dist/tinymce-plugin-text-indent-outdent/plugin.min.js': [
            'src/text/license-header.js',
            scratchPluginMinPath
          ]
        }
        ...
        files: [
          {
            cwd: 'src/text',
            src: ['license.txt'],
            dest: 'dist/tinymce-plugin-text-indent-outdent',
            expand: true
          },
          { src: ['changelog.txt'], dest: 'dist/tinymce-plugin-text-indent-outdent', expand: true }
        ]
      }
    },
  ...
  grunt.registerTask('version', 'Creates a version file', function () {
    grunt.file.write('dist/tinymce-plugin-text-indent-outdent/version.txt', BUILD_VERSION);
  });
