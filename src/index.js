...
const setup = (editor, url) => {
  ...
  if (
    ...
    if (/^[a-z%]+$/i.test(pluginTextIndentOutdent.unit)) {
      indentUnit = pluginTextIndentOutdent.unit;
    }
    if (!isNaN(pluginTextIndentOutdent.value)) {
      indentValue = pluginTextIndentOutdent.value;
    }
  }
